...
PeerSession::PeerSession(boost::asio::io_context &io) : m_io(io) {}

PeerSession::PeerSession(boost::asio::io_context &io,
                         boost::asio::ip::tcp::socket socket) : m_io(io)
{
    m_socket = std::make_unique<boost::asio::ip::tcp::socket>(std::move(socket));
}

void PeerSession::Send(boost::asio::yield_context yield,
...
std::vector<unsigned char> PeerSession::Recieve(boost::asio::yield_context yield,
                          boost::system::error_code &ec)
{
