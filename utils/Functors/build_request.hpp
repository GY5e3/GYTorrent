...
namespace utils
{
    ...
    public:
        ...
        void operator()(std::vector<unsigned char> &request, size_t offset, integer value)
        {
        ...
        void operator()(std::vector<unsigned char>& request, size_t offset, iterator begin, iterator end)
        {
